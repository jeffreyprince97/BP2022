...
if __name__ == "__main__":
    projectdir = r"/Users/JeffreyPrince/Documents/GitHub/BP"+os.sep
    
    os.chdir(projectdir)
    img_dir = r'out/circle4.MOV/' #Mappe navn
    model_dir = r'/Users/JeffreyPrince/Documents/GitHub/BP/step1tf/'

    
    images_to_classify = glob.glob(img_dir+"*.png")[:]
    os.chdir(model_dir)
    ...
    #         #print("Classifiying image {} of {}".format(i+1, len(images_to_classify)))
    #         image = Image.open(image_path)

    #         outputs = model.predict(image)
    #         with open("/Users/JeffreyPrince/Documents/GitHub/BP/predictsout/comments.txt", "a") as f:
    #             for cc in outputs:
    #                 f.write("%s;\n%s;\n\n" % (timestr,outputs))